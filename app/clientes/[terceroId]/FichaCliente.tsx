...
/**
 * La ficha fiscal de un cliente.
 *
 * Isla de cliente adentro de una Server Page: lo único que cruza la frontera es
 * el formulario. La lectura —quién es, qué le falta— la dibuja el servidor.
 *
